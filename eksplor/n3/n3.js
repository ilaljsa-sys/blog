...
window.renderFuriganaHtml = function(text) {
  ...
  // 1. Format Spreadsheet: Kanji[furigana] (mendukung kanji tunggal & jukugo)
...
window.tutupDisplayEksplor = function() {
  ...
  // Langsung pindah ke halaman /eksplor/
...
// Ambil semua data diam-diam di latar belakang
window.addEventListener("DOMContentLoaded", () => {
  ...
  daftarSheetN3.forEach((sheetName, index) => {
    const cacheKey = `cache_n3_${sheetName}`;
    // kalo belum ada di memori browser, download secara bertahap tanpa mengganggu UI
